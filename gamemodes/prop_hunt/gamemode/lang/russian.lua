...
LANG.PHEMENU.ABOUT.DONATE = "ПОЖЕРТВОВАТЬ проект PH:E"
LANG.PHEMENU.ABOUT.HOME = "Официальная домашняя страница PH:E"
LANG.PHEMENU.ABOUT.GIT = "Репозиторий GitHub"
LANG.PHEMENU.ABOUT.WIKI = "Руководства и Wiki PH:E"
LANG.PHEMENU.ABOUT.PLUGINS = "PH:E Аддоны/Плагины"
