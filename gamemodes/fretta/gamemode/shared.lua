...
function GM:GetHunterCount(playerCount)
	...
	local customHunterCount = GetConVar("ph_huntercount"):GetInt()
...
function GM:PlayerFootstep(ply, pos, foot, sound, volume, rf)
	if GAMEMODE.NoPlayerFootsteps or not ply:Alive() or ply:Team() == TEAM_SPECTATOR or ply:IsObserver() then
		return true
	end
